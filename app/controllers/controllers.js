...
app.controller('ImageListController',['$scope', '$rootScope', '$moment', '$http', function($scope, $rootScope, $moment, $http){
 ...
 //    $http.ajax({
	...
	// });
    // $http.ajax('https://api.flickr.com/services/feeds/photos_public.gne?tags=potato&tagmode=all&format=json').then(function(res) {
    //     $scope.dat = res.data;
	...
	//Tuesday, September 22nd 2015, 3:57:33 am
	//8th April 2012, at 12:00 // MMMM Do YYYY at hh:mm
...
// app.controller('ImageDetailController', ['$scope', '$http', function($scope, $http){
// 	$scope.val = 15;
// }]);
